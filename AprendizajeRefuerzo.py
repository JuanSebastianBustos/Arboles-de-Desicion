...
def plot_training_progress():
    ...
    ax1.plot(episodes, agent.rewards_history, alpha=0.3, label='Recompensa por episodio')
    ax1.plot(episodes, agent.avg_rewards_history, linewidth=2, label='Promedio móvil (100 episodios)')
...
def get_training_stats():
    ...
    return {
        ...
        'avg_reward': np.mean(agent.avg_rewards_history[-100:]) if len(agent.avg_rewards_history) >= 100 else 0,
